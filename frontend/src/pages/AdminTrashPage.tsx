...
export function AdminTrashPage() {
  ...
  return (
    <div>
      ...
      {trash.data && rows.length === 0 && <Empty label={t("Trash is empty.")} icon={Trash2} />}
                  ...
                  <td className="px-3 py-2 text-right">
                    <div className="flex items-center justify-end gap-0.5">
                      <button
                        ...
                        className="inline-flex items-center justify-center rounded-md p-2 text-slate-500 transition-colors duration-150 hover:bg-slate-100 hover:text-slate-900 dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-slate-100"
                      >
                      ...
                      <button
                        ...
                        className="inline-flex items-center justify-center rounded-md p-2 text-slate-400 transition-colors duration-150 hover:bg-red-50 hover:text-red-600 dark:text-slate-300 dark:hover:bg-red-950/40 dark:hover:text-red-300"
                      >
